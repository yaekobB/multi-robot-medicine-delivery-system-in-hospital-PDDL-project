...
(define (problem hospital4_bool)
  ...
  (:init
    ...
    ;; carico robot = 0
    (robot_load_0 robot1) (robot_load_0 robot2)
    (robot_load_0 robot3) (robot_load_0 robot4)
    ...
    (at_floor storage    floor0)  (at_floor robot_room floor0)
    ...
    (not(can_use robot1)) (not(can_use robot3))
    (not(can_use robot2)) (not(can_use robot4))
